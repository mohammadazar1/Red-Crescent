...
class HypothermiaPage extends StatefulWidget {
  const HypothermiaPage({Key? key}) : super(key: key);

  @override

  State<HypothermiaPage> createState() => _HypothermiaState();
}

class _HypothermiaState extends State<HypothermiaPage> {
  @override
  //int role=0;
  Widget build(BuildContext context) {
    //if (role ==1) {
